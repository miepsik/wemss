...
!function (t, n) {
    ...
    return o.prototype = {
        constructor: o, init: function () {
            ...
            (this.hasClass("top") && this.removeClass("notTop")) || (this.addClass("top"), this.removeClass("notTop"), this.onTop && this.onTop.call(this))
        }, notTop: function () {
            this.hasClass("notTop") || (this.addClass("notTop", 300), this.removeClass("top"), this.onNotTop && this.onNotTop.call(this))
        }, bottom: function () {
        ...
        }, addClass: function (t, d=0) {
            setTimeout(() => {this.elem.classList.add(this.classes[t]);}, d);
